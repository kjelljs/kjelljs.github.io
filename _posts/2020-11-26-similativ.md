...
<p>Og ettersom ordstillingen ikke får til å sondre mellom de to typene, vil vi få tvetydigheter: Setning (3) for eksempel kan ha strukturen i (4) eller (5).
  ...
  <ul><li> &nbsp;<span style="margin-right: -2pt">[</span>[PT<span style="margin-right: -2pt">]</span>] = λP λX X&#8714; { Y&oplus;Z | Y&#8714;*P, Z&#8714;*P<sup>~</sup> } </li></ul><p>*M er den kumulative tillukningen over M, mengden av summer av ting i M.</p>
